...
const DescriptionSection = ({id, imageAlt, text, index}: DescriptionSectionProps & {index: number}) => {
    ...
    return (
        <section className={`flex flex-row items-center gap-6   ${isImageRight ?  "" :  "flex-row-reverse"} `}>
            <div id="content" className="flex justify-center mt-[70px] mb-[30px] w-full h-[200px] bg-cover bg-center
