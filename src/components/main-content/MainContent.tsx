...
const MainContent = () => {
  return (
    <main className="bg-foreground min-h-screen flex flex-col items-center justify-center px-6">
      <section className="w-90% flex justify-center items-center pt-48 pb-12 md:pb-0 md:pt-[180px] mb-15">
        <Image
      ...
      <div className="flex justify-center items-center gap-4 md:gap-2 w-auto max-w-[900px] flex-col md:flex-row">
        <ImageButton
      ...
      <section className="w-full max-w-[700px] text-center px-4">
        <p className="text-hero-body text-md md:text-2xl leading-relaxed mt-8 mb-8 tracking-tighter md:tracking-tight">
