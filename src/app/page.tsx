...
import HpCover from '@/components/HpCover';
    ...
    <>
      ...
      <PageTransition>
        <div>
          ...
          <main className="bg-[var(--background)] flex flex-col items-center justify-center py-10 min-h-screen w-full overflow-x-hidden">
